...
class CGameObject_Static final : public CGameObject
{
public:
...
private:
	explicit CGameObject_Static(LPDIRECT3DDEVICE9 pGraphic_Device);
...
public:
	static CGameObject_Static* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
