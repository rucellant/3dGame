...
class CParticle_Crystal final : public CParticle
{
public:
...
public:
	explicit CParticle_Crystal(LPDIRECT3DDEVICE9 pGraphic_Device);
	explicit CParticle_Crystal(const CParticle_Crystal& rhs);
	virtual ~CParticle_Crystal() = default;
public:
...
public:
	static CParticle_Crystal* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
