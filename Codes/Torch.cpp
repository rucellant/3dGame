...
HRESULT CTorch::Ready_GameObject_Prototype()
{
	return NOERROR;
}

HRESULT CTorch::Ready_GameObject_Clone(void * pArg)
{
...
_int CTorch::Update_GameObject(_double TimeDelta)
{
	return _int();
}

_int CTorch::LateUpdate_GameObject(_double TimeDelta)
{
...
HRESULT CTorch::Render_GameObject()
{
...
HRESULT CTorch::Add_Component(void * pArg)
{
	...
	// For Com_Shader
	if (CGameObject::Add_Component(SCENE_STATIC, L"Component_Shader_Mesh_Static", L"Com_Shader_Mesh", (CComponent**)&m_pShaderCom))
		return E_FAIL;
	...
	// For. Com_Mesh
	if (CGameObject::Add_Component(SCENE_STATIC, L"Component_Mesh_Torch", L"Com_Mesh", (CComponent**)&m_pMeshCom))
		return E_FAIL;

	return NOERROR;
}

HRESULT CTorch::SetUp_ConstantTable()
{
...
HRESULT CTorch::Render(_uint iPassIndex)
{
...
CTorch * CTorch::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	...
	{
		MSG_BOX("Failed while Creating CTorch");
...
CGameObject * CTorch::Clone_GameObject(void * pArg)
{
