...
HRESULT CHpBar::Ready_GameObject_Clone(void * pArg)
{
	...
	m_tDesc[1].fY = 0.0f + g_iWinCY * 0.8f;
...
HRESULT CHpBar::Add_Component(void * pArg)
{
	// For.Com_Shader
...
HRESULT CHpBar::SetUp_ConstantTable(_uint iIndex)
{
...
HRESULT CHpBar::Render(_uint iPassIndex)
{
