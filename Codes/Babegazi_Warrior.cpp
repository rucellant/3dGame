#include "stdafx.h"
#include "..\Headers\Babegazi_Warrior.h"
#include "Management.h"

USING(Client)

CBabegazi_Warrior::CBabegazi_Warrior(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CMonster(pGraphic_Device)
{
}

CBabegazi_Warrior::CBabegazi_Warrior(const CBabegazi_Warrior & rhs)
	: CMonster(rhs)
{
}

HRESULT CBabegazi_Warrior::Ready_GameObject_Prototype()
{
	return NOERROR;
}

HRESULT CBabegazi_Warrior::Ready_GameObject_Clone(void * pArg)
{
...
_int CBabegazi_Warrior::Update_GameObject(_double TimeDelta)
{
...
_int CBabegazi_Warrior::LateUpdate_GameObject(_double TimeDelta)
{
...
HRESULT CBabegazi_Warrior::Render_GameObject()
{
...
HRESULT CBabegazi_Warrior::Add_Component(void * pArg)
{
	...
	// For. Com_Mesh
	if (CGameObject::Add_Component(SCENE_STAGE, L"Component_Mesh_Babegazi_Warrior", L"Com_Mesh", (CComponent**)&m_pMeshCom))
		return E_FAIL;

	return NOERROR;
}

HRESULT CBabegazi_Warrior::SetUp_ConstantTable()
{
...
HRESULT CBabegazi_Warrior::Render(_uint iPassIndex)
{
...
CBabegazi_Warrior * CBabegazi_Warrior::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CBabegazi_Warrior* pInstance = new CBabegazi_Warrior(pGraphic_Device);

	if (FAILED(pInstance->Ready_GameObject_Prototype()))
	{
		MSG_BOX("Failed while Creating CBabegazi_Warrior");
...
CGameObject * CBabegazi_Warrior::Clone_GameObject(void * pArg)
{
	CBabegazi_Warrior* pInstance = new CBabegazi_Warrior(*this);
