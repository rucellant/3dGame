#include "stdafx.h"
#include "..\Headers\Knole_Commander.h"
#include "Management.h"

USING(Client)

CKnole_Commander::CKnole_Commander(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CMonster(pGraphic_Device)
{
}

CKnole_Commander::CKnole_Commander(const CKnole_Commander & rhs)
	: CMonster(rhs)
{
}

HRESULT CKnole_Commander::Ready_GameObject_Prototype()
{
	return NOERROR;
}

HRESULT CKnole_Commander::Ready_GameObject_Clone(void * pArg)
{
...
_int CKnole_Commander::LateUpdate_GameObject(_double TimeDelta)
{
...
HRESULT CKnole_Commander::Render_GameObject()
{
...
HRESULT CKnole_Commander::Add_Component(void * pArg)
{
...
HRESULT CKnole_Commander::SetUp_ConstantTable()
{
...
HRESULT CKnole_Commander::Render(_uint iPassIndex)
{
...
CKnole_Commander * CKnole_Commander::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	...
	{
		MSG_BOX("Failed while Creating CKnole_Commander");
...
CGameObject * CKnole_Commander::Clone_GameObject(void * pArg)
{
	CKnole_Commander* pInstance = new CKnole_Commander(*this);
